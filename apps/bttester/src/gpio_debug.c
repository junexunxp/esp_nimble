...
static const int dbug_gpio[8]={0x28,0x28,0x28,0x28,0x25,0x26,0x27,0x28};
...
gpio_dbug_init(void)
{
	...
	NRF_GPIO_Type *port;
	port = HAL_GPIO_PORT(0x22);
    int pin_index = HAL_GPIO_INDEX(0x22);
	uint32_t conf = GPIO_PIN_CNF_PULL_Pullup << GPIO_PIN_CNF_PULL_Pos;
